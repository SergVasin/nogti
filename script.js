...
$(document).ready(function(){
  ...
  $(".specialist__foto-slider").owlCarousel({
    items: 1,
    loop: true,
    dots: false,
    nav: true,
...
$( document ).ready(function() {
  $(".specialist__slider-add").click(function() {        
    $(this).parents().eq(0).find('.specialist__slider-wr').addClass("specialist__slider__open");
  })
});

$( document ).ready(function() {
  $(".specialist__slider-close").click(function() {        
    $('.specialist__slider-wr').removeClass("specialist__slider__open");
  })
});

$( document ).ready(function() {
  $(".forum__send-text").click(function() {        
    $(this).parents().eq(0).find('.forum__send-form').addClass("forum__send-form-add");
  })
});
$( document ).ready(function() {
  $(".forum__send-form-close").click(function() {        
    $('.forum__send-form').removeClass("forum__send-form-add");
  })
});

$( document ).ready(function() {
  $(".reg__btn-text").click(function() {        
    $(this).parents().eq(0).find('.reg__btn-form').addClass("reg__btn-form-add");
  })
});
$( document ).ready(function() {
  $(".reg__btn-form-close").click(function() {        
    $('.reg__btn-form').removeClass("reg__btn-form-add");
  })
});